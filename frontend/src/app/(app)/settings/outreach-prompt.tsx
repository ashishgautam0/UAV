    ...
    <CardContent className="space-y-3">
      <div className="rounded-lg border p-3">
        <div role="toolbar" aria-label={`${title} actions`} className="mb-3 flex flex-wrap gap-2">
          ...
          <Button variant="outline" disabled={busy || dirty || !generated?.ready} onClick={async () => {
            try { await navigator.clipboard.writeText(generated!.prompt); toast.success(`${title} copied`); }
