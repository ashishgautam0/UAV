...
class SettingsProfileTests(unittest.TestCase):
    ...
    def test_ready_prompt_resolves_fixed_batch_resume_and_saved_answers(self):
        ...
        self.assertIn("Pause for login, CAPTCHA, or a missing truthful answer", prompt)
        ...
        self.assertIn("For a temporary page error, login, CAPTCHA, or uncertain availability, leave its card", prompt)
